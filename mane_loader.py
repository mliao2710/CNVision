...
def load_gene_mapping(mapping_file="data/gene2refseq.gz"):
    ...
    if not os.path.exists(full_path):
        ...
        print("  cd data && curl -O https://ftp.ncbi.nlm.nih.gov/gene/DATA/gene2refseq.gz")
        return mapping
